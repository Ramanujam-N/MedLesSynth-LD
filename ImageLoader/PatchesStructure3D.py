...
class PatchesStructure3D(Dataset):
    def __init__(self,paths,gt_path=None,image_size =(128,128,128),type_of_imgs = 'nifty',no_crop=False, transform=None,data='wmh',resize=True, return_size = False,return_orig=False,scale_factor=5,use_rician=True):
    ...
    def __getitem__(self,index):
        ...
        inter_image +=+ self.gaussian_noise(size=self.image_size)
        data_dict = {}
