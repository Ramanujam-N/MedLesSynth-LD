...
class SmoothNoise2D(Dataset):
    def __init__(self,paths,gt_paths,paths_clean=None,image_size =(128,128),type_of_imgs = 'png', recon=False,no_crop=False, transform=None,data='busi',return_size = False,return_orig=False,sigma_noise=1,sigma_smooth=1,setting='smooth'):
        self.paths = paths
    ...
    def __getitem__(self,index):
        ...
        if(self.setting == 'smooth'):
            ...
            image = 0.1*self.sigma_noise*np.random.randn(*image.shape) + 0.9*image
