...
class PatchesStructure2D(Dataset):
    def __init__(self,paths,gt_path = None,image_size =(512,512),type_of_imgs = 'nifty',no_crop=False, transform=None,data='wmh',resize=True, return_size = False,return_orig=False,scale_factor=5,use_rician=True):
