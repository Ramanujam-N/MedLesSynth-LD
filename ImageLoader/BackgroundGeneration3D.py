...
class BackgroundGeneration3D(Dataset):
    def __init__(self, type_of_imgs='nifty',have_texture=True,have_noise=True, have_smoothing=True, have_small=True, have_edema=True, return_param=True, transform=None, dark=True, which_data='wmh',perturb=False, size=(128,128),semi_axis_range=[(5,10)],centroid_scale=10,num_lesions=5,range_sampling=[1],num_ellipses=15):
    ...
    def simulation(self,image_mask):
        ...
        roi = skimage.morphology.binary_erosion(image_mask,skimage.morphology.ball(15))
        roi_with_masks = roi
