...
class FPILoader2D(Dataset):
    ...
    def __getitem__(self, index):
        ...
        labels = skimage.measure.label(inter_gt)
        ...
        image[coords_x[0]:coords_x[1],coords_y[0]:coords_y[1]] = (1-alpha)*inter_image[min_row:max_row,min_col:max_col] + alpha*image[coords_x[0]:coords_x[1],coords_y[0]:coords_y[1]]
        gt = gt>0
